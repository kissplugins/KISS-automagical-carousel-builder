...
add_filter( 'the_content', function ( $html ) {
	...
	wp_add_inline_style( 'kacb-inline', <<<CSS
		...
		.kacb-filename{display:none;           /* ← hidden by default */
		  position:absolute;top:0;left:0;right:0;background:rgba(0,0,0,.5);color:#fff;
		  padding:.25em 1em;font:12px/1.4 sans-serif;z-index:9}
		.kacb-caption{position:absolute;bottom:0;left:0;right:0;background:rgba(0,0,0,.5);color:#fff;
		  padding:.5em 1em;min-height:3em;font:14px/1.4 sans-serif;display:flex;align-items:center;z-index:9}
	CSS);
